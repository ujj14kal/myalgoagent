...
const sections: LegalSection[] = [
  {
    ...
    bullets: [
      "Instrument, strategy, timeframe and historical period",
  ...
  },
  {
    ...
    soon: ["Trading-session and calendar awareness", "Explicit handling of missing or invalid market data"],
  },
  {
    id: "metrics",
    ...
    bullets: [
      ...
      "Equity curve and a trade-by-trade history",
    ],
    soon: [
      "Average drawdown and recovery factor",
      "Sortino and Calmar ratios, volatility",
      "Largest win/loss",
