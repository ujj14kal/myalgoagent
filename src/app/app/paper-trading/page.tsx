...
export default async function PaperTradingPage() {
  ...
  return (
    <div>
      ...
      {sessions.length === 0 ? (
        <div className="mt-8">
          <EmptyState pose="idle" title="No paper trading sessions yet." description="Start one above to run a strategy forward with virtual capital against real market data." />
        </div>
      ) : (
