...
export default async function AccountPage() {
  ...
  const [user, strategyCount, watchlistCount] = await Promise.all([
        ...
        <div className="sticky top-6 h-fit space-y-6">
          ...
          <section className="rounded-2xl border border-black/5 bg-white p-6">
            ...
            <dl className="mt-4 space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between">
                <dt className="text-brand-navy/50">Sign-in method</dt>
                <dd className="font-medium text-brand-navy">{user.passwordHash ? "Username + Google" : "Google"}</dd>
              </div>
              <div className="flex items-center justify-between">
